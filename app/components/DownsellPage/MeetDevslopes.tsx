          ...
          <div className="flex-center-start flex-column" style={{minHeight: '100vh'}}>
            <Image src="./DownsellPage/dollars.svg" className="a-meetdevslopes" height={300} width={300} alt="dollars"></Image>
              <h1 className="font-l a-meetdevslopes centered-text">
                ...
                <div className="feedback-column-wrapper  a-meetdevslopes flex-start-start">
                <div className="feedback-column flex-center-center flex-column">
                ...
                <h2><span className="pink-text bold centered-text"> Earn While You Learn</span> works because it attacks the doubt within you, and proves that anything is possible!</h2>
          </div>
        </div>
